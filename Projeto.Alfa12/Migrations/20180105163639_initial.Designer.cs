...
namespace Projeto.Alfa12.Migrations
{
    ...
    [Migration("20180105163639_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projeto.Alfa12.Models.AlunoGamification", b =>
                {
                    b.Property<int>("AlunoId");
            ...
            modelBuilder.Entity("Projeto.Alfa12.Models.AlunoConquista", b =>
                {
                    b.HasOne("Projeto.Alfa12.Models.AlunoGamification", "Aluno")
                        .WithMany("Conquistas")
            ...
            modelBuilder.Entity("Projeto.Alfa12.Models.AlunoGamification", b =>
                {
                    b.HasOne("Projeto.Alfa12.Models.Aluno", "Aluno")
                        .WithOne("AlunoGamification")
                        .HasForeignKey("Projeto.Alfa12.Models.AlunoGamification", "AlunoId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Projeto.Alfa12.Models.Pontuacao", b =>
                {
                    b.HasOne("Projeto.Alfa12.Models.AlunoGamification")
                        .WithMany("Pontuacao")
                        .HasForeignKey("AlunoId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Projeto.Alfa12.Models.Turma", b =>
                {
                    ...
                    b.HasOne("Projeto.Alfa12.Models.Turma")
                        .WithMany("Modulos")
                        .HasForeignKey("TurmaId");
                });
